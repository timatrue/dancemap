L.Control.PopupMobile = L.Control.extend({
    ...
    initialize: function (container, options) {
        ...
        this._wrapper = L.DomUtil.create('div',modality+' leaflet-popup-mobile-wrapper', L.DomUtil.get(this.options.element));
  ...
  enableBtn: function(){
    ...
    show: function (position) {
        ...
        if (this.options.position == 'topLeft'){
            ...
            //this.showOn([left+width/2-thisWidth/2-margin, top+height/2-thisHeight/2-margin+offset])
...
L.control.popupMobile = function (container, options) {
    return new L.Control.PopupMobile(container, options);
};